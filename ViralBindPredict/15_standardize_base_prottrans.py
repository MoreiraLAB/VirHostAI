...
input_dir = "splits_prottrans_output"
output_dir = "splits_prottrans_output_standardized"
os.makedirs(output_dir, exist_ok=True)

splits = {
    "train": "prottrans_train.hdf5",
    "test": "prottrans_test.hdf5",
    "val": "prottrans_val.hdf5",
    "blind": "prottrans_blind.hdf5",
    "blind_ligand": "prottrans_blind_ligand.hdf5",
    "blind_protein": "prottrans_blind_protein.hdf5",
}
...
# Save scalers
joblib.dump(prot_scaler, os.path.join(output_dir, "prot_scaler_prottrans_base.pkl"))
joblib.dump(lig_scaler, os.path.join(output_dir, "lig_scaler_prottrans_base.pkl"))
...
for split_file in [
    'prottrans_train_standardized.hdf5',
    'prottrans_test_standardized.hdf5',
    'prottrans_val_standardized.hdf5',
    'prottrans_blind_standardized.hdf5',
    'prottrans_blind_ligand_standardized.hdf5',
    'prottrans_blind_protein_standardized.hdf5'
]:
    validate_first5_shapes(os.path.join("splits_prottrans_output_standardized", split_file))