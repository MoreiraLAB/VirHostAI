...
input_dir = "splits_esm2_output"
output_dir = "splits_esm2_output_standardized"
os.makedirs(output_dir, exist_ok=True)

splits = {
    "train": "esm2_train.hdf5",
    "test": "esm2_test.hdf5",
    "val": "esm2_val.hdf5",
    "blind": "esm2_blind.hdf5",
    "blind_ligand": "esm2_blind_ligand.hdf5",
    "blind_protein": "esm2_blind_protein.hdf5",
}
...
# Save scalers
joblib.dump(prot_scaler, os.path.join(output_dir, "prot_scaler_esm2_base.pkl"))
joblib.dump(lig_scaler, os.path.join(output_dir, "lig_scaler_esm2_base.pkl"))
...
for split_file in [
    'esm2_train_standardized.hdf5',
    'esm2_test_standardized.hdf5',
    'esm2_val_standardized.hdf5',
    'esm2_blind_standardized.hdf5',
    'esm2_blind_ligand_standardized.hdf5',
    'esm2_blind_protein_standardized.hdf5'
]:
    validate_first5_shapes(os.path.join("splits_esm2_output_standardized", split_file))