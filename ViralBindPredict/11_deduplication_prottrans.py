...
original_hdf5_path = "interaction_dataset_prottrans_mordred.hdf5"
deduplicated_df_path = "deduplicated_filtered_prottrans_df.xlsx"
output_hdf5_path = "interaction_dataset_prottrans_mordred_deduplicated.hdf5"
log_file = "deduplication_prottrans_log.txt"
...
for _, row in dedup_df.iterrows():
    ...
    ligands_to_copy.add(f"{lig_id}_{lig_chain}")
