...
input_dir = "splits_prottrans_output_90%"
output_dir = "splits_prottrans_output_standardized_90%"
os.makedirs(output_dir, exist_ok=True)

splits = {
    "train": "prottrans_train_90%.hdf5",
    "test": "prottrans_test_90%.hdf5",
    "val": "prottrans_val_90%.hdf5",
    "blind": "prottrans_blind_90%.hdf5",
    "blind_ligand": "prottrans_blind_ligand_90%.hdf5",
    "blind_protein": "prottrans_blind_protein_90%.hdf5",
}
...
# Save scalers
joblib.dump(prot_scaler, os.path.join(output_dir, "prot_scaler_prottrans_90%.pkl"))
joblib.dump(lig_scaler, os.path.join(output_dir, "lig_scaler_prottrans_90%.pkl"))
...
for split_file in [
    'prottrans_train_90%_standardized.hdf5',
    'prottrans_test_90%_standardized.hdf5',
    'prottrans_val_90%_standardized.hdf5',
    'prottrans_blind_90%_standardized.hdf5',
    'prottrans_blind_ligand_90%_standardized.hdf5',
    'prottrans_blind_protein_90%_standardized.hdf5'
]:
    validate_first5_shapes(os.path.join("splits_prottrans_output_standardized_90%", split_file))