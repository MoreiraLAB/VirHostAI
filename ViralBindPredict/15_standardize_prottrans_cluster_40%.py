...
input_dir = "splits_prottrans_output_40%"
output_dir = "splits_prottrans_output_standardized_40%"
os.makedirs(output_dir, exist_ok=True)

splits = {
    "train": "prottrans_train_40%.hdf5",
    "test": "prottrans_test_40%.hdf5",
    "val": "prottrans_val_40%.hdf5",
    "blind": "prottrans_blind_40%.hdf5",
    "blind_ligand": "prottrans_blind_ligand_40%.hdf5",
    "blind_protein": "prottrans_blind_protein_40%.hdf5",
}
...
# Save scalers
joblib.dump(prot_scaler, os.path.join(output_dir, "prot_scaler_40%_prottrans.pkl"))
joblib.dump(lig_scaler, os.path.join(output_dir, "lig_scaler_40%_prottrans.pkl"))
...
for split_file in [
    'prottrans_train_40%_standardized.hdf5',
    'prottrans_test_40%_standardized.hdf5',
    'prottrans_val_40%_standardized.hdf5',
    'prottrans_blind_40%_standardized.hdf5',
    'prottrans_blind_ligand_40%_standardized.hdf5',
    'prottrans_blind_protein_40%_standardized.hdf5'
]:
    validate_first5_shapes(os.path.join("splits_prottrans_output_standardized_40%", split_file))