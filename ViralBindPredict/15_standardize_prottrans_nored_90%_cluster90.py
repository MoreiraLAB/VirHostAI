...
input_dir = "splits_prottrans_output_nored_90%_cluster90"
output_dir = "splits_prottrans_output_standardized_nored_90%_cluster90"
os.makedirs(output_dir, exist_ok=True)

splits = {
    "train": "prottrans_train_nored_90%_cluster90.hdf5",
    "test": "prottrans_test_nored_90%_cluster90.hdf5",
    "val": "prottrans_val_nored_90%_cluster90.hdf5",
    "blind": "prottrans_blind_nored_90%_cluster90.hdf5",
    "blind_ligand": "prottrans_blind_ligand_nored_90%_cluster90.hdf5",
    "blind_protein": "prottrans_blind_protein_nored_90%_cluster90.hdf5",
}
...
# Save scalers
joblib.dump(prot_scaler, os.path.join(output_dir, "prot_scaler_prottrans_nored90%_cluster90.pkl"))
joblib.dump(lig_scaler, os.path.join(output_dir, "lig_scaler_prottrans_nored90%_cluster90.pkl"))
    ...
    with h5py.File(hdf5_path, 'r') as f:
        ...
        for prot in f['proteins']:
            for chain in f[f'proteins/{prot}']:
                ...
                print(f"Values (first row, first 10 features):\n{data[0, :10] if data.ndim == 2 else data[:10]}")
                prot_printed += 1
                if prot_printed >= 5:
                    break
            if prot_printed >= 5:
...
for split_file in [
    'prottrans_train_nored_90%_cluster90_standardized.hdf5',
    'prottrans_test_nored_90%_cluster90_standardized.hdf5',
    'prottrans_val_nored_90%_cluster90_standardized.hdf5',
    'prottrans_blind_nored_90%_cluster90_standardized.hdf5',
    'prottrans_blind_ligand_nored_90%_cluster90_standardized.hdf5',
    'prottrans_blind_protein_nored_90%_cluster90_standardized.hdf5'
]:
    validate_first5_shapes(os.path.join("splits_prottrans_output_standardized_nored_90%_cluster90", split_file))