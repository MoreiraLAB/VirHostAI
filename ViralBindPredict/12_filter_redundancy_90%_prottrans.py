...
input_hdf5 = "interaction_dataset_prottrans_mordred_deduplicated.hdf5"
filtered_fasta_file = "mmseqs2_90seqs.fasta"  # FASTA of representative sequences after 90% redundancy removal
seq_mapping_excel = "deduplicated_filtered_prottrans_df.xlsx"
output_hdf5 = "interaction_dataset_prottrans_mordred_deduplicated_no_red.hdf5"
