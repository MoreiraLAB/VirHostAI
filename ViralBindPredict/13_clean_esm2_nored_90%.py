...
def analyze_interactions(file_path, results_dir="Results"):
    ...
    with open(os.path.join(results_dir, 'unique_prot_c-esm2.txt'), 'w') as f:
        f.write("\n".join(sorted(unique_prot_c)))
    with open(os.path.join(results_dir, 'unique_prot-esm2.txt'), 'w') as f:
        f.write("\n".join(sorted(unique_prot)))
    with open(os.path.join(results_dir, 'unique_ligands-esm2.txt'), 'w') as f:
        f.write("\n".join(sorted(unique_ligands)))
    with open(os.path.join(results_dir, 'unique_prot_c_lig-esm2.txt'), 'w') as f:
    ...
    counts_df_interacting.to_csv(os.path.join(results_dir, 'interacting_residues_counts-esm2.csv'), index=False)
    counts_df_non_interacting.to_csv(os.path.join(results_dir, 'non_interacting_residues_counts-esm2.csv'), index=False)
...
original_path = "interaction_dataset_esm2_mordred_deduplicated_no_red.hdf5"
cleaned_path = "viralbindpredictDB-esm2-cleaned_no_red.hdf5"
