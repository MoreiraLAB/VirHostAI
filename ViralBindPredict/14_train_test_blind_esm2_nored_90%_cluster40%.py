...
def split_all(
    ...
    # Save splits
    save_split_hdf5(original_hdf5, os.path.join(output_dir, "esm2_train_nored_90%_cluster40.hdf5"), train_ids, "train")
    save_split_hdf5(original_hdf5, os.path.join(output_dir, "esm2_val_nored_90%_cluster40.hdf5"),   val_ids,   "val")
    save_split_hdf5(original_hdf5, os.path.join(output_dir, "esm2_test_nored_90%_cluster40.hdf5"),  test_ids, "test")
    save_split_hdf5(original_hdf5, os.path.join(output_dir, "esm2_blind_nored_90%_cluster40.hdf5"), blind_ids, "blind")
    save_split_hdf5(original_hdf5, os.path.join(output_dir, "esm2_blind_protein_nored_90%_cluster40.hdf5"), blind_protein_ids, "blind_protein")
    save_split_hdf5(original_hdf5, os.path.join(output_dir, "esm2_blind_ligand_nored_90%_cluster40.hdf5"),  blind_ligand_ids,  "blind_ligand")
...
split_all("viralbindpredictDB-esm2-cleaned_no_red.hdf5", "deduplicated_esm2_mordred_filtered_df_nored.xlsx", output_dir="splits_esm2_output_nored_90%_cluster40", test_size=0.1, blind_frac=0.1, val_size=0.1, seed=87, mmseqs_clusters_path="mmseqs2_40clusters_nored.txt")
...
# Validate splits
for split_file in [
    'esm2_train_nored_90%_cluster40.hdf5',
    'esm2_test_nored_90%_cluster40.hdf5',
    'esm2_val_nored_90%_cluster40.hdf5',
    'esm2_blind_nored_90%_cluster40.hdf5',
    'esm2_blind_ligand_nored_90%_cluster40.hdf5',
    'esm2_blind_protein_nored_90%_cluster40.hdf5'
]:
    validate_first3_shapes(os.path.join("splits_esm2_output_nored_90%_cluster40", split_file))