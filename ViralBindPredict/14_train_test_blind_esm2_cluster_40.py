...
def split_all(
    ...
    # Save splits
    save_split_hdf5(original_hdf5, os.path.join(output_dir, "esm2_train_40%.hdf5"), train_ids, "train")
    save_split_hdf5(original_hdf5, os.path.join(output_dir, "esm2_val_40%.hdf5"),   val_ids,   "val")
    save_split_hdf5(original_hdf5, os.path.join(output_dir, "esm2_test_40%.hdf5"),  test_ids, "test")
    save_split_hdf5(original_hdf5, os.path.join(output_dir, "esm2_blind_40%.hdf5"), blind_ids, "blind")
    save_split_hdf5(original_hdf5, os.path.join(output_dir, "esm2_blind_protein_40%.hdf5"), blind_protein_ids, "blind_protein")
    save_split_hdf5(original_hdf5, os.path.join(output_dir, "esm2_blind_ligand_40%.hdf5"),  blind_ligand_ids,  "blind_ligand")
...
split_all("viralbindpredictDB-esm2-cleaned.hdf5", "deduplicated_esm2_mordred_filtered_df.xlsx", output_dir="splits_esm2_output_40%", test_size=0.1, blind_frac=0.1, val_size=0.1, seed=52, mmseqs_clusters_path="mmseqs2_40clusters.txt")
...
for split_file in [
    ...
    'esm2_val_40%.hdf5',
    'esm2_blind_40%.hdf5',
    'esm2_blind_ligand_40%.hdf5',
    'esm2_blind_protein_40%.hdf5'
]:
    validate_first3_shapes(os.path.join("splits_esm2_output_40%", split_file))