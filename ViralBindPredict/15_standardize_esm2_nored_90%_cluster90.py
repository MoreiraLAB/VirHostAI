...
input_dir = "splits_esm2_output_nored_90%_cluster90"
output_dir = "splits_esm2_output_standardized_nored_90%_cluster90"
os.makedirs(output_dir, exist_ok=True)

splits = {
    "train": "esm2_train_nored_90%_cluster90.hdf5",
    "test": "esm2_test_nored_90%_cluster90.hdf5",
    "val": "esm2_val_nored_90%_cluster90.hdf5",
    "blind": "esm2_blind_nored_90%_cluster90.hdf5",
    "blind_ligand": "esm2_blind_ligand_nored_90%_cluster90.hdf5",
    "blind_protein": "esm2_blind_protein_nored_90%_cluster90.hdf5",
}
...
# Save scalers
joblib.dump(prot_scaler, os.path.join(output_dir, "prot_scaler_esm2_nored90%_cluster90.pkl"))
joblib.dump(lig_scaler, os.path.join(output_dir, "lig_scaler_esm2_nored90%_cluster90.pkl"))
...
for split_file in [
    'esm2_train_nored_90%_cluster90_standardized.hdf5',
    'esm2_test_nored_90%_cluster90_standardized.hdf5',
    'esm2_val_nored_90%_cluster90_standardized.hdf5',
    'esm2_blind_nored_90%_cluster90_standardized.hdf5',
    'esm2_blind_ligand_nored_90%_cluster90_standardized.hdf5',
    'esm2_blind_protein_nored_90%_cluster90_standardized.hdf5'
]:
    validate_first5_shapes(os.path.join("splits_esm2_output_standardized_nored_90%_cluster90", split_file))